...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans bg-gray-background text-gray-900 text-sm">
        ...
        <main class="container mx-auto max-w-custom flex" >
            <div class="w-70 mr-5">
                <div class="bg-white border-2 border-blue rounded-xl my-16"
                    style="
                    ...
                    <div class="text-center px-6 py-2 pt-6">
                        ...
                        <p class="text-cs mt-4">Let us know what you would like and we'll take a look over!</p>
                    </div>

                    <form action="#" method="POST" class="space-y-4 px-4 py-6">
                        <div>
                            <input type="text" class="w-full text-sm bg-gray-100 border-none
                        ...
                        <div>
                            <textarea name="idead" id="id" cols="30" rows="4"
                                class="w-full bg-gray-100 rounded-xl placegolder-gray-900
                                text-sm- px-4 py-2 border-none"
                                placeholder="Describe your idea"
                            ></textarea>
                        </div>
                        <div class="flex items-center justify-betwee space-x-3">
                            ...
                            <button type="submit" class="flex items-center justify-center w-1/2 h-11
